...
export default {
  ...
  data () {
    ...
    return {
      ...
      contextmenuList: [
        { icon: 'arrow-left', title: 'Shut down the left side of the', value: 'left' },
        { icon: 'arrow-right', title: 'Shut down the right side of the', value: 'right' },
        { icon: 'times', title: 'Close the other', value: 'other' },
        { icon: 'times-circle', title: 'Close all', value: 'all' }
      ],
      tagName: '/index'
    }
